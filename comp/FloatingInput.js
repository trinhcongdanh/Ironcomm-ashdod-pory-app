...
import {
    View, Text, TextInput, Image, Dimensions, TouchableOpacity
} from 'react-native';
...
export default class RNFloatingInput extends React.Component {
    ...
    render() {
        const {label, labelSize, labelSizeLarge , labelColor, textInputStyle, onPress, onChangeTextInput ,editable = false, showArrow = true, ...props} = this.props;
        ...
        return (
            <TouchableOpacity
                ...
                <Image
                    ...
                    resizeMode="cover"
                    style={{width:screenWidth*0.03, height:screenWidth*0.03*(14/24), marginBottom:10,
