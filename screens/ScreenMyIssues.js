...
// export const MyIssuesScreen = () => {
//   const [appState, setAppState] = useState(AppState.currentState);
//   const [issuesFullList, setIssuesFullList] = useState([]);
//   const [issuesList, setIssuesList] = useState([]);
//   const [isFilterDialogShown, setIsFilterDialogShown] = useState(false);
//   const [isSortDialogShown, setIsSortDialogShown] = useState(false);
//   const [isLastUpdateDialogShown, setIsLastUpdateDialogShown] = useState(false);
//   const [isShowClearFilter, setIsShowClearFilter] = useState(false);
//   const [sortText, setSortText] = useState(sortByLastUpdate);
...
//   const [numOfUpdate, setNumOfUpdate] = useState(0);
//   const [isRefreshing, setIsRefreshing] = useState(false);
//   const [isFastFilter, setIsFastFilter] = useState(true);
...
//       loadAppConfig().then(() => {
//         // loadIssues();
//         didFocusSubscription = navigation.addListener('didFocus', () => {
//           loadIssues();
//         });
//       });
//     });
...
//   const openActiveIssueScreen = issueId => {
//     let item = {};
//     for (let i = 0; i < issuesList.length; i++) {
//       if (issueId == issuesList[i]['issue_id']) {
//         item = issuesList[i];
//       }
//     }
//     navigation.dispatch(
//       StackActions.push(ActiveIssueScreenName, {
//         issue_id: issueId,
//         issue_status: appConfig.issue_statuses[item.status]['name'],
//       }),
//     );
//   };

//   const startFCMListening = async () => {
...
//   const updateFCMWithServer = async token => {
//     let dataObj = {
...
//           navigation.dispatch(
//             StackActions.replace(LoginScreenName, {
//               isTokenExpire: true,
//             }),
//           );
//         } else {
...
//     for (let i = 0; i < issuesList.length; i++) {
//       if (
//         issuesList[i]['title'].includes(text) ||
//         issuesList[i]['serial_number'].includes(text) ||
//         text == ''
//       ) {
//         issuesList[i]['isShown'] = true;
//         setIssuesList(issuesList);
//       } else {
//         issuesList[i]['isShown'] = false;
//         setIssuesList(issuesList);
//       }
//     }
//   };
...
//     return appConfig.commands[commandId];
//   };
...
//         setFilterList([]);
//         for (let i = 1; i < 6; i++) {
//           if (appConfig.issue_statuses[i + ''] != null) {
//             let item = {
//               type: 'filter_statuses',
//               name: appConfig.issue_statuses[i + '']['name'],
//               color: appConfig.issue_statuses[i + '']['color'],
...
//       sort_by: 4,
//     };
//     if (sortText == sortByDateCreated) {
//       dataObj.sort_by = 1;
//     } else if (sortText == sortByPrior) {
//       dataObj.sort_by = 2;
//     } else if (sortText == sortByStatus) {
//       dataObj.sort_by = 3;
//     } else if (sortText == sortByLastUpdate) {
//       dataObj.sort_by = 4;
//     } else if (sortText == sortBySmallSort) {
//       dataObj.sort_by = 5;
//     }
...
//           setIssuesList(issueListInJson);
//           for (let i = 0; i < issuesList.length; i++) {
//             issuesList[i]['isShown'] = true;
//             setIssuesList(issuesList);
//           }
//           setIssueStatusCount(issueTypeCountInJson);
//           setNumOfUpdate(responseJson.num_of_updates);
//           if (isDefaultFilter) {
//             setFilterList([]);
...
//           );
//         } else {
//           alert('Khong tim thay api param');
//         }
...
//     for (let i = 0; i < filterList.length; i++) {
//       if (
//         filterList[i]['type'] == item['type'] &&
//         filterList[i]['name'] == item['name']
//       ) {
//         pos = i;
//       }
//     }
...
//   const handleRefreshList = isListRefreshing => {
//     setIsRefreshing(isListRefreshing);
//     if (isListRefreshing) {
//       loadIssues();
//     }
//   };
...
//   const openIssueFilterDialog = () => {
//     // props.navigation.navigate(IssuesFilterScreenName);
//     setIsFilterDialogShown(true);
//   };

//   const closeIssueFilterDialog = (data, isCancel) => {
//     if (!isCancel) {
//       setIsDefaultFilter(false);
//       if (data != '') {
...
//             filterList.push(selectedFilterItem);
//           }
//           setIsFastFilter(false);
//         }
//       } else {
...
//       if (isFastFilter) {
//         setFilterList([]);
//         Object.keys(issueStatusCount).map(key => {
//           let filterItem = {
//             id: key,
//             name: issueStatusCount[key]['name'],
//             color: issueStatusCount[key]['color'],
//             count: issueStatusCount[key]['count'],
//             value: key,
//             type: 'filter_statuses',
//           };
//           filterList.push(filterItem);
...
//   const openSortSelectDialog = () => {
//     // props.navigation.navigate(IssuesFilterScreenName);
//     setIsSortDialogShown(true);
//   };

//   const closeSortSelectDialog = data => {
//     if (data != '') {
//       setSortText(data);
//       setIsSortDialogShown(false);
//       loadIssues();
//     } else {
//       setIsSortDialogShown(false);
//     }
...
//   const openLastUpdateDialog = () => {
//     // props.navigation.navigate(IssuesFilterScreenName);
//     setIsLastUpdateDialogShown(true);
//   };

//   const closeLastUpdateDialog = data => {
//     setIsLastUpdateDialogShown(false);
//   };

//   const comeToNewIssueScreen = () => {
//     navigation.dispatch(StackActions.push(NewIssueScreenName));
//   };

//   const comeToStatusInfoScreen = () => {
//     navigation.dispatch(StackActions.push(StatusInfoScreenName));
//   };

//   const openIssueInfo = item => {
//     if (isLastUpdateDialogShown) {
//       closeLastUpdateDialog('');
//     }
//     openActiveIssueScreen(item.issue_id);
//   };
...
//               navigation.dispatch(StackActions.replace(LoginScreenName));
//             },
//           );
//         } catch (e) {
//           // saving error
...
//   const menuView = (
//     <MenuView onItemSelected={item => onMenuItemSelected(item)} />
//   );
//   return (
//     <SideMenu
//       menu={menuView}
...
//               borderRadius: 5,
//               display: !isFastFilter ? 'flex' : 'none',
//             }}>
//             <Image
//               source={require('../image/icon_close_white.png')}
//               resizeMode="contain"
...
//                           top: 0,
//                           start: 0,
//                           color: item.is_new == 1 ? text_issues_new : '#ffffff',
//                           backgroundColor:
//                             item.is_new == 1
//                               ? bg_issues_new
//                               : appConfig.issue_statuses[item.status]['color'],
//                         },
//                       ]}>
//                       {appConfig.issue_statuses[item.status]['name']}
//                     </Text>
//                     <View
//                       style={{
//                         flexDirection: 'column',
...
//                             {marginEnd: 5},
//                           ]}>
//                           {getCommandName(item.command_id)}
//                         </Text>
...
//                         {updated +
//                           ' ' +
//                           moment(item.last_update).local().format('DD/MM/YYYY')}
//                       </Text>
//                     </View>
//                   </TouchableOpacity>
//                 );
...
//           visible={isFilterDialogShown}
//           transparent={false}>
//           <IssuesFilterScreen
//             statusType={issueStatusCount}
//             filterList={filterList}
//             isFastFilter={isFastFilter}
//             closeIssueFilter={closeIssueFilterDialog}
//             style={{
//               zIndex: 2,
//               width: screenWidth,
//               height: screenHeight,
...
//           animationType="slide"
//           presentationStyle="fullScreen"
//           visible={isSortDialogShown}
//           transparent={false}>
//           <SortSelectScreen
//             userInfo={userInfo}
//             closeSortDialog={closeSortSelectDialog}
//             sortText={sortText}
//             style={{
//               zIndex: 2,
//               width: screenWidth,
...
//             closeLastUpdateDialog();
//           }}
//           visible={isLastUpdateDialogShown}
//           transparent={false}>
//           <LastUpdateScreen
//             closeLastUpdateDialog={closeLastUpdateDialog}
//             viewIssueItem={openIssueInfo}
//             token={userInfo.token}
//             style={{
//               zIndex: 2,
//               width: screenWidth,
